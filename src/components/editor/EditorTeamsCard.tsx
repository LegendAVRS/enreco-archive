...
export default function EditorTeamsCard({
    ...
    const addNewTeam = (event: React.FormEvent<AddNewTeamFormElement>) => {
        ...
        const newTeamIconUrl = event.currentTarget.elements.newTeamIconUrl.value;

        if((!autoGenIdFromName && !newTeamId) || !newTeamName || !newTeamIconUrl) {
            return;
        }
    ...
    return (
        <EditorCard>
            ...
            <table className="w-full table-fixed border border-black border-collapse">
                <thead>
                    <tr>
                        <th scope="col" className="text-left border border-black p-2 w-16">Icon</th>
                        ...
                        <th scope="col" className="text-left border border-black p-2">Icon Image URL</th>
                    </tr>
                </thead>
                <tbody>
                {
